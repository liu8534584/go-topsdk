...
type TaobaoTbkScGeneralLinkConvertRequest struct {
	...
	PromotionType *int64 `json:"promotion_type,omitempty" required:"false" `
	/*
	   物料列表，可以为url或淘口令     */
	MaterialList *int64 `json:"material_list,omitempty" required:"false" `
	/*
	...
	AdzoneId *string `json:"adzone_id,omitempty" required:"true" `

	/* 卖家ID列表 */
	SellerIdList *string `json:"seller_id_list,omitempty" required:"false" `

	/* 推广位id，mm_xx_xx_xx pid三段式中的第二段 */
	SiteId *string `json:"site_id" required:"true" `
...
func (req *TaobaoTbkScGeneralLinkConvertRequest) SetPromotionType(promotionType int64) *TaobaoTbkScGeneralLinkConvertRequest {
	req.PromotionType = &promotionType
	return req
}

func (req *TaobaoTbkScGeneralLinkConvertRequest) SetMaterialList(materialList int64) *TaobaoTbkScGeneralLinkConvertRequest {
	req.MaterialList = &materialList
	return req
}

func (req *TaobaoTbkScGeneralLinkConvertRequest) SetRelationId(relationId int64) *TaobaoTbkScGeneralLinkConvertRequest {
	req.RelationId = &relationId
	return req
}

func (req *TaobaoTbkScGeneralLinkConvertRequest) SetAdzoneId(adzoneId string) *TaobaoTbkScGeneralLinkConvertRequest {
...
func (req *TaobaoTbkScGeneralLinkConvertRequest) SetSiteId(siteId string) *TaobaoTbkScGeneralLinkConvertRequest {
	req.SiteId = &siteId
	return req
}
